$(document).ready(function() {
    ...
    var questions = [
        'You had a good interaction with other people.',
        'You spoke with at least 2 new people.',
        'Your were invited two or more days before the event.',
        'The venu was easy to locate.',
        'You expected more people at the event.',
        'You could easily count at least 20 people at the event.',
        'You had something you liked. (Talk of food and drinks)',
        'You consider yourself as a STEM professional or student.',
        'You think it is a good idea to have such a group as Africans in STEM.',
        'You will likely attend if invited again.'
    ];
